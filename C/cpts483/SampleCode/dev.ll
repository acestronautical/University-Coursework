...
@addCounter.1 = private unnamed_addr constant [19 x i8] c"\0A\0A addCounter: %d\0A\00", align 1
...
entry:
  ...
  %ctrload = load i64, i64* @addCounter
  %counterinc = add i64 1, %ctrload
  store i64 %counterinc, i64* @addCounter
  %add = add nsw i32 %0, %1
...
entry:
  ...
  %ctrload1 = load i64, i64* @addCounter
  %counterinc2 = add i64 1, %ctrload1
  store i64 %counterinc2, i64* @addCounter
...
for.inc:                                          ; preds = %for.body
  ...
  %ctrload3 = load i64, i64* @addCounter
  %counterinc4 = add i64 1, %ctrload3
  store i64 %counterinc4, i64* @addCounter
  %inc = add nsw i32 %9, 1
...
for.end:                                          ; preds = %for.cond
  ...
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @addCounter.1, i32 0, i32 0), i64 %addCounter.val)
  ret i32 0
}
